...
## Sonata No. 4  
The first movement of Sonata No. 4 follows the same structure as the third movement of Sonata No. 1 (Adagio–Presto–Adagio), adopting the French overture form characterized by a slow–fast–slow sequence.  
| Movement | Tempo | Key | Time Signature | Form |
| -------- | ----- | --- | -------------- | ---- |
...
## Sonata No. 6  
Sonata No. 6 contains the greatest number of movements among the six violin sonatas published in 1707.  
| Movement | Tempo | Key | Time Signature | Form |
| -------- | ----- | --- | -------------- | ---- |
