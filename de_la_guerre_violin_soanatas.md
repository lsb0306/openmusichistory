...
| 1707 | 6 Violin Sonatas | [Listen🔈](https://youtu.be/IUlW1Uj7G5E?si=AkYUVasKfqH5uP0S) |More actions
...
## Sonata No. 4  
The first movement of Sonata No. 4 follows the same structure as the third movement of Sonata No. 1 (Adagio–Presto–Adagio), adopting the French overture form characterized by a slow–fast–slow sequence. In the third movement, the violin part features melismatic ornamentation, and both Phrygian cadences and half cadences appear.  
| Movement | Tempo | Key | Time Signature | Form |
| -------- | ----- | --- | -------------- | ---- |
